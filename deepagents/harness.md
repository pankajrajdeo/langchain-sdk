...
Optional capabilities such as [task planning](https://docs.langchain.com/oss/python/deepagents/harness#task-planning) and [skills](https://docs.langchain.com/oss/python/deepagents/harness#skills) extend the harness when your use case needs them.
...
See [Core capabilities](https://docs.langchain.com/oss/python/deepagents/harness#core-capabilities) for a full breakdown of each component.
...
#### [Execution environment](https://docs.langchain.com/oss/python/deepagents/harness#execution-environment)
Tools, virtual filesystem, optional sandbox, and REPL (interpreter)

#### [Context management](https://docs.langchain.com/oss/python/deepagents/harness#context-management)
Skills, memory, summarization, context offloading, and prompt caching

#### [Delegation](https://docs.langchain.com/oss/python/deepagents/harness#delegation)
Subagent spawning and optional task planning

#### [Steering](https://docs.langchain.com/oss/python/deepagents/harness#steering)
...
* **[Tools](https://docs.langchain.com/oss/python/deepagents/harness#tools-and-mcp)**: custom functions, APIs, and databases the agent can call
* **[Virtual filesystem](https://docs.langchain.com/oss/python/deepagents/harness#virtual-filesystem-access)**: file tools backed by pluggable backends
* **[Filesystem permissions](https://docs.langchain.com/oss/python/deepagents/harness#filesystem-permissions)**: declarative access control over which paths agents can read or write
* **[Code execution](https://docs.langchain.com/oss/python/deepagents/harness#code-execution)**: sandboxed shell execution and an in-process JavaScript interpreter

**[Streaming](https://docs.langchain.com/oss/python/deepagents/harness#streaming)** allows you to keep up with everything happening using typed event streams for messages, tools, values, and delegated tasks.
...
* **[Skills](https://docs.langchain.com/oss/python/deepagents/harness#skills)**: on-demand domain knowledge loaded progressively from skill files
* **[Memory](https://docs.langchain.com/oss/python/deepagents/harness#memory)**: persistent instructions and preferences loaded at startup from `AGENTS.md` files
* **[Summarization and context offloading](https://docs.langchain.com/oss/python/deepagents/harness#summarization-and-context-offloading)**: automatic compression of conversation history and large tool results
* **[Prompt caching](https://docs.langchain.com/oss/python/deepagents/harness#prompt-caching)**: static prompt sections are cache-eligible to speed up inference and reduce cost on supported models
...
* **Isolation**: Subagents quarantine heavy subtasks and return only final results (see [Delegation](https://docs.langchain.com/oss/python/deepagents/harness#delegation)).
...
* **[Task planning](https://docs.langchain.com/oss/python/deepagents/harness#task-planning)**: an opt-in `write_todos` tool for structured task tracking
* **[Subagents](https://docs.langchain.com/oss/python/deepagents/harness#subagents)**: ephemeral child agents that handle isolated subtasks
