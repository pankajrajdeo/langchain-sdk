...
* **A managed runtime**: [LangSmith Deployment's Agent Server](../langsmith/agent-server-overview.md) hosts and operates the agent, and keeps sessions running across restarts.
...
| [MCP connectors](../langsmith/python/managed-deep-agents-mcp-connectors.md)            | `connectors/`     | Remote MCP servers that provide tools to the agent.                                      |
...
For the full layout, see [Project structure](../langsmith/python/managed-deep-agents-project-structure.md).
