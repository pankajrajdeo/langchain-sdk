...
> Integrate with the AI21SemanticTextSplitter document transformer using LangChain Python.
...
We'll need to get a AI21 API key and set the AI21\_API\_KEY environment variable:
