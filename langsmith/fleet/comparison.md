...
[**LangSmith Fleet**](https://docs.langchain.com/langsmith/fleet/index) is an enterprise agent platform for building, sharing, and governing agents across your organization. This page compares it with similar platforms to help you choose the right one for your team.

| **Platform**                              | **Choose if...**                                                                                                                                                                                                                                                                                        |
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [LangSmith Fleet](https://docs.langchain.com/langsmith/fleet/index) | You want to build and share purpose-built agents across your organization, stay model-agnostic, and keep full observability via LangSmith. **Fleet** is the only option with a self-hosted deployment path and the ability to export agents to code via [Deep Agents](https://docs.langchain.com/oss/python/deepagents/overview). |
...
| **Self-hosting**        | ✅ [beta](https://docs.langchain.com/langsmith/deploy-self-hosted-full-platform#enable-fleet-insights-and-chat), [contact sales](https://www.langchain.com/contact-sales) for production readiness details                | ❌                                           | ❌                                              | ❌                                   | ❌                                                                      |
| **Code export**         | ✅ [Export to Deep Agents](https://docs.langchain.com/langsmith/fleet/code)                                                                                                                                               | ❌                                           | ❌                                              | ❌                                   | ❌                                                                      |
...
| **Code export license** | MIT ([Deep Agents](https://docs.langchain.com/oss/python/deepagents/overview))                                                                                                                                           | N/A                                         | N/A                                            | N/A                                 | N/A                                                                    |
...
| Slack-native integration    | ✅ [Native Slack app](https://docs.langchain.com/langsmith/fleet/slack-app)                                                                                                          | ✅                 | ✅                | ⚠️                          | ⚠️  (via Azure Bot Service) |
| Microsoft Teams integration | ✅ [Teams app](https://docs.langchain.com/langsmith/fleet/teams-app)                                                                                                                 | ✅                 | ✅                | ❌                           | ✅                           |
| Scheduled runs              | ✅ [Schedules](https://docs.langchain.com/langsmith/fleet/schedules)                                                                                                                 | ✅                 | ✅                | ✅                           | ✅                           |
| Sub-agents                  | ✅ [Sub-agents](https://docs.langchain.com/langsmith/fleet/essentials#sub-agents)                                                                                                    | ✅                 | ✅                | ❌                           | ✅                           |
| Skills system               | ✅ [Skills](https://docs.langchain.com/langsmith/fleet/skills)                                                                                                                       | ✅                 | ❌                | ❌                           | —                           |
| Human-in-the-loop           | ✅ [Central approvals inbox](https://docs.langchain.com/langsmith/fleet/essentials#human-in-the-loop)                                                                                | ✅                 | ✅                | ⚠️                          | ⚠️                          |
| MCP client                  | ✅ [Remote MCP servers](https://docs.langchain.com/langsmith/fleet/remote-mcp-servers)                                                                                               | ✅                 | ✅                | ❌                           | ✅                           |
...
| Feature                              | **Fleet**                                                                                                | **Claude Cowork** | **Amazon Quick** | **Google Workspace Studio** | **Microsoft Copilot** |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------- | ----------------- | ---------------- | --------------------------- | --------------------- |
| Role-based access control            | ✅ [RBAC with per-tool permissions](https://docs.langchain.com/langsmith/rbac)                                                      | ✅                 | ✅                | ✅                           | ✅                     |
| Attribute-based access control       | ✅ [Per MCP server and integration](https://docs.langchain.com/langsmith/fleet/access-and-oversight#attribute-based-access-control) | ❌                 | ❌                | ❌                           | —                     |
| Per-agent sharing and permissions    | ✅ [Clone, Run, and Edit access per agent](https://docs.langchain.com/langsmith/fleet/access-and-oversight#permissions-and-sharing) | ⚠️                | ✅                | ⚠️                          | ✅                     |
| Credential model (fixed or per-user) | ✅ [Configurable per agent](https://docs.langchain.com/langsmith/fleet/access-and-oversight#agent-identity-and-credentials)         | ✅                 | ✅                | ✅                           | ✅                     |
| Spend limits                         | ⚠️ Managed at workspace level                                                                            | ✅                 | ⚠️               | ⚠️                          | ✅                     |
| SCIM provisioning                    | ✅                                                                                                        | ✅                 | ✅                | —                           | ✅                     |
| Audit trail                          | ✅ [Structured LangSmith traces](https://docs.langchain.com/langsmith/fleet/access-and-oversight#observability-and-audit-trail)     | ✅                 | ✅                | ✅                           | ✅                     |
...
| Feature                         | **Fleet**                                                                                                           | **Claude Cowork** | **Amazon Quick** | **Google Workspace Studio** | **Microsoft Copilot** |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ----------------- | ---------------- | --------------------------- | --------------------- |
| Long-term memory                | ✅ [Persistent memory files across sessions](https://docs.langchain.com/langsmith/fleet/essentials#memory)                                     | ✅                 | ✅                | ❌                           | —                     |
| Thread-scoped context           | ✅                                                                                                                   | ✅                 | ✅                | ✅                           | ✅                     |
| Self-updating agents            | ✅ [Agents can add tools, remove tools, and update their own instructions](https://docs.langchain.com/langsmith/fleet/essentials#self-updates) | ❌                 | ❌                | ❌                           | ❌                     |
| Approval gate for memory writes | ✅ [Configurable per agent](https://docs.langchain.com/langsmith/fleet/manage-agent-settings)                                                  | ❌                 | ❌                | ❌                           | —                     |
...
| Feature        | **Fleet**                                                    | **Claude Cowork** | **Amazon Quick** | **Google Workspace Studio** | **Microsoft Copilot** |
| -------------- | ------------------------------------------------------------ | ----------------- | ---------------- | --------------------------- | --------------------- |
| Native tracing | ✅ [LangSmith traces for every run](https://docs.langchain.com/langsmith/observability) | ✅                 | ⚠️               | ⚠️                          | ⚠️                    |
| Evaluations    | ✅ [LangSmith evaluations](https://docs.langchain.com/langsmith/evaluation-concepts)    | ❌                 | ❌                | ❌                           | ⚠️                    |

### Code export and hosting

**Fleet** lets you export any agent you build to code via [Deep Agents](https://docs.langchain.com/oss/python/deepagents/overview), the open-source agent runtime that Fleet runs on. Exported agents are MIT-licensed and can be deployed independently of Fleet, modified in code, or integrated directly into your own applications via the [API](https://docs.langchain.com/langsmith/fleet/code). None of the other platforms in this comparison offer a code export path.
...
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ---------------- | --------------------------- | --------------------- |
| Cloud-hosted              | ✅                                                                                                                                                                               | ⚠️                | ✅                | ✅                           | ✅                     |
| Self-hosted               | ✅ [beta](https://docs.langchain.com/langsmith/deploy-self-hosted-full-platform#enable-fleet-insights-and-chat), [contact sales](https://www.langchain.com/contact-sales) for production readiness details | ❌                 | ❌                | ❌                           | ❌                     |
| Custom models             | ⚠️ [Enterprise only](https://docs.langchain.com/langsmith/fleet/essentials#custom-models)                                                                                                                 | ❌                 | ❌                | ⚠️                          | ⚠️                    |
| Call agents from your app | ✅ [API access](https://docs.langchain.com/langsmith/fleet/code)                                                                                                                                           | ✅                 | ⚠️               | ❌                           | ✅                     |
| Export to code            | ✅ [Export to Deep Agents](https://docs.langchain.com/langsmith/fleet/code)                                                                                                                                | ❌                 | ❌                | ❌                           | ❌                     |

### Integrations and tools

A ✅ indicates the integration is available; supported actions and depth vary by platform. See [Fleet tool integrations](https://docs.langchain.com/langsmith/fleet/tools) for the full list of Fleet's built-in integrations and what each one can do.
...
| GitHub                                            | ✅                                       | ✅                 | ✅                | —                           | —                     |
| Slack                                             | ✅ [Native](https://docs.langchain.com/langsmith/fleet/slack-app)  | ✅                 | ✅                | ⚠️                          | ❌                     |
| CRM (Salesforce, HubSpot)                         | ✅                                       | —                 | ✅                | ⚠️                          | ✅                     |
| Project management (Linear, Jira, Notion)         | ✅                                       | ✅                 | ✅                | ⚠️                          | ⚠️                    |
| Custom tools via MCP                              | ✅                                       | ✅                 | ✅                | ❌                           | ✅                     |
| Webhooks                                          | ✅ [Webhooks](https://docs.langchain.com/langsmith/fleet/webhooks) | ❌                 | ❌                | ⚠️                          | ✅                     |
