...
You will start from the prebuilt **Executive Assistant** [template](https://docs.langchain.com/langsmith/fleet/templates), which manages your inbox, calendar, and daily brief.
...
Fleet manages the AI model for you, so you do not need your own model provider API key. For more information, see [Models](https://docs.langchain.com/langsmith/fleet/essentials#models).
...
When the agent prompts you to connect a channel, click **Skip for now**. You connect channels in a [later step](https://docs.langchain.com/langsmith/fleet/quickstart#3-configure-your-agent).
...
A connection gives your agent the [tools](https://docs.langchain.com/langsmith/fleet/tools) to use a service. A [channel](https://docs.langchain.com/langsmith/fleet/channels) lets the service trigger the agent. You connect Gmail and Google Calendar here, then add Gmail as a channel in [Configure your agent](https://docs.langchain.com/langsmith/fleet/quickstart#3-configure-your-agent).
...
> [!NOTE]
> Your agent only accesses your accounts when working on tasks you give it. You can revoke access anytime in the [agent sidebar](https://docs.langchain.com/langsmith/fleet/essentials#agent-sidebar) or your Google account settings.
...
* Modifying settings in the [agent sidebar](https://docs.langchain.com/langsmith/fleet/essentials#agent-sidebar)
...
### View connections
Expand the **Connections** drawer. **Gmail** and **Google Calendar** appear as **Connected**. If either shows as not connected, complete [2. Connect tools](https://docs.langchain.com/langsmith/fleet/quickstart#2-connect-tools) before continuing.
...
For **Apply Label**, click **Ask**, so your agent pauses and waits for your approval before continuing. You can accept the proposed action, or reject it and tell the agent what to change. For more information, see [Human-in-the-loop](https://docs.langchain.com/langsmith/fleet/essentials#human-in-the-loop).
...
You may want to update your agent's instructions or include more tools. You can chat with your agent directly to ask for updates, or configure it from the [agent sidebar](https://docs.langchain.com/langsmith/fleet/essentials#agent-sidebar):

* Edit the agent's instructions (its `AGENTS.md`) in the **Knowledge** drawer. See [Instructions](https://docs.langchain.com/langsmith/fleet/essentials#instructions).
* Add integrations and tools in the **Connections** drawer, and set each tool to run automatically or [ask for approval](https://docs.langchain.com/langsmith/fleet/essentials#human-in-the-loop). See [Tools](https://docs.langchain.com/langsmith/fleet/tools).
* Connect [Slack](https://docs.langchain.com/langsmith/fleet/slack-app), [Gmail](https://docs.langchain.com/langsmith/fleet/channels#add-a-gmail-channel), or [Microsoft Teams](https://docs.langchain.com/langsmith/fleet/teams-app) in the **Channels** drawer.
* Run your agent on a [schedule](https://docs.langchain.com/langsmith/fleet/schedules) in the **Schedules** drawer.
* Change the [model](https://docs.langchain.com/langsmith/fleet/manage-agent-settings#change-the-model) in the **Advanced settings** drawer.

## Next steps

Now that you have created your first agent, here is what to explore:

#### [Try more templates](https://docs.langchain.com/langsmith/fleet/templates)
Explore prebuilt agents for common tasks

#### [Add automation](https://docs.langchain.com/langsmith/fleet/essentials#channels)
Run your agent automatically with channels (Slack, email, schedules)

#### [Connect more tools](https://docs.langchain.com/langsmith/fleet/tools)
Add Slack, GitHub, Linear, and more

#### [Build complex agents](https://docs.langchain.com/langsmith/fleet/essentials#sub-agents)
