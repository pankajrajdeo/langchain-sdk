...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/platform/annotation-queues/{queue_id}/items/{item_id}/placement
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /api/v1/platform/annotation-queues/{queue_id}/items/{item_id}/placement:
    get:
      ...
      description: >-
        ...
        zero-based position for deep linking.
      parameters:
