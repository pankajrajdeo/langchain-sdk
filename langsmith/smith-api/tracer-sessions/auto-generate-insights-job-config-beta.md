...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/sessions/{session_id}/insights/configs/generate
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
components:
  schemas:
    ...
    GenerateClusteringJobConfigResponse:
      ...
      description: >-
        Auto-generated clustering job config (not persisted; frontend creates
        the config).
    HTTPValidationError:
      properties:
        detail:
