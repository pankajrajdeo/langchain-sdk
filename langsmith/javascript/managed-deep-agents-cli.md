...
> Source: [Original LangChain documentation](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-cli)
Reference for mda commands, project files, and deploy behavior.

The `mda` CLI compiles and deploys code-first [Managed Deep Agents](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-overview).
...
For the fastest end-to-end path, see the [quickstart](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-quickstart). For workflow guidance, see [Identity](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-identity), [Memory](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-memory), [Evals](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-evals), [Custom tools](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-tools), [Custom middleware](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-middleware), [Sandboxes](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-sandboxes), [Channels](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-channels), [Schedules](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-schedules), and [Deploy an agent](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-deploy).
...
For Harbor task authoring, optional scaffolding, credentials, and running trials, see [Evals](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-evals).
...
On success, the CLI prints the LangSmith deployment dashboard URL. For secrets routing and deploy tips, see [Deploy an agent](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-deploy).
