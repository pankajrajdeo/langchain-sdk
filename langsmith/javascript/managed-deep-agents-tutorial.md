...
> Source: [Original LangChain documentation](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-tutorial)
...
For more on authored tools, see [Custom tools](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-tools).
...
See [Memory](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-memory) for details.
...
`mda deploy` reconciles this schedule into a LangSmith cron job after the deployment is live. For thread behavior and constraints, see [Schedules](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-schedules).
...
#### [Sandboxes](https://docs.langchain.com/langsmith/javascript/managed-deep-agents-sandboxes)
