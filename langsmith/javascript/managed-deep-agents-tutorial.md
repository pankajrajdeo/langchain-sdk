...
This tutorial continues from the [quickstart](managed-deep-agents-quickstart.md). Use the `research-assistant` project you created there, with your model, instructions, search tool, and a working `mda dev` setup.
