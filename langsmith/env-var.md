...
When set to `"mongo"`, you must also provide the MongoDB connection URI via [`LS_MONGODB_URI`](https://docs.langchain.com/langsmith/env-var#ls_mongodb_uri).
