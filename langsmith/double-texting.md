...
[Enqueue](https://docs.langchain.com/langsmith/double-texting#enqueue-default) is the default double texting (multi-tasking) strategy when creating runs in the [Agent Server](https://docs.langchain.com/langsmith/agent-server).

> [!NOTE]
> Double texting is a feature of LangSmith Deployment. It is not available in the [LangGraph open source framework](https://docs.langchain.com/oss/python/langgraph/overview).

> **Image:** [Double-text strategies across first vs. second run: Reject keeps only the first; Enqueue runs the second afterward; Interrupt halts the first to run the second; Rollback reverts the first and reruns with the second.](https://docs.langchain.com/langsmith/double-texting)
...
For configuring the enqueue double text option, refer to the [how-to guide](https://docs.langchain.com/langsmith/enqueue-concurrent).
...
For configuring the reject double text option, refer to the [how-to guide](https://docs.langchain.com/langsmith/reject-concurrent).
...
For configuring the interrupt double text option, refer to the [how-to guide](https://docs.langchain.com/langsmith/interrupt-concurrent).
...
For configuring the rollback double text option, refer to the [how-to guide](https://docs.langchain.com/langsmith/rollback-concurrent).
