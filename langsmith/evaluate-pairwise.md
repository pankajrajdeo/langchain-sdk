...
> [!NOTE]
> Concept: [Pairwise evaluations](https://docs.langchain.com/langsmith/evaluation-concepts#pairwise)

LangSmith supports evaluating **existing** experiments in a comparative manner. Instead of evaluating one output at a time, you can score the output from multiple experiments against each other. In this guide, you'll use [`evaluate()`](https://docs.smith.langchain.com/reference/python/evaluation/langsmith.evaluation._runner.evaluate) with two existing experiments to [define an evaluator](https://docs.langchain.com/langsmith/evaluate-pairwise#define-a-pairwise-evaluator) and [run a pairwise evaluation](https://docs.langchain.com/langsmith/evaluate-pairwise#run-a-pairwise-evaluation). Finally, you'll use the LangSmith UI to [view the pairwise experiments](https://docs.langchain.com/langsmith/evaluate-pairwise#view-pairwise-experiments).

## Prerequisites

* If you haven't already created experiments to compare, check out the [quick start](https://docs.langchain.com/langsmith/evaluation-quickstart) or the [how-to guide](https://docs.langchain.com/langsmith/evaluate-llm-application) to get started with evaluations.
...
* `runs: list[Run]`: A two-item list of the full [Run](https://docs.langchain.com/langsmith/run-data-format) objects generated by the two experiments on the given example. Use this if you need access to intermediate steps or metadata about each run.
* `example: Example`: The full dataset [Example](https://docs.langchain.com/langsmith/example-data-format), including the example inputs, outputs (if available), and metadata (if available).
...
> [!NOTE]
> In the Python example below, we are pulling [this structured prompt](https://smith.langchain.com/hub/langchain-ai/pairwise-evaluation-2) from the [LangChain Hub](https://docs.langchain.com/langsmith/manage-prompts#public-prompt-hub) and using it with a LangChain chat model wrapper.
>
...
> **Image:** [Pairwise Experiments Tab](https://docs.langchain.com/langsmith/evaluate-pairwise)

Click on a pairwise experiment that you would like to inspect, and you will be brought to the Comparison View:

> **Image:** [Pairwise Comparison View](https://docs.langchain.com/langsmith/evaluate-pairwise)
...
> **Image:** [Pairwise Filtering](https://docs.langchain.com/langsmith/evaluate-pairwise)
