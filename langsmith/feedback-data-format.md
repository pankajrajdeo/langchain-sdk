...
1. [Sent up along with a trace](https://docs.langchain.com/langsmith/attach-user-feedback) from the LLM application
2. Generated by a user in the app [inline](https://docs.langchain.com/langsmith/annotate-traces-inline) or in an [annotation queue](https://docs.langchain.com/langsmith/annotation-queues)
3. Generated by an automatic evaluator during [offline evaluation](https://docs.langchain.com/langsmith/evaluate-llm-application)
4. Generated by an [online evaluator](https://docs.langchain.com/langsmith/online-evaluations-llm-as-judge)
