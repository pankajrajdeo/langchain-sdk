...
Use [instructions](https://docs.langchain.com/langsmith/python/managed-deep-agents-instructions) for behavior that should ALWAYS be loaded by the agent.

Use [memory](https://docs.langchain.com/langsmith/python/managed-deep-agents-memory) for knowledge you want the agent to be able to update.

For skill authoring patterns and the complete format, see [Skills](https://docs.langchain.com/oss/python/deepagents/skills).
