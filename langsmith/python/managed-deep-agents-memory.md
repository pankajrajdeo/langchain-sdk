...
Memory is not your system prompt. Define always-on behavior in [instructions](https://docs.langchain.com/langsmith/python/managed-deep-agents-instructions) and task-specific procedures in [skills](https://docs.langchain.com/langsmith/python/managed-deep-agents-skills); use memory for durable knowledge the agent learns while it runs.
