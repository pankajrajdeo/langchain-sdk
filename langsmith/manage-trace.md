...
You can [share a trace publicly](https://docs.langchain.com/langsmith/manage-trace#share-a-trace), and [view the server logs](https://docs.langchain.com/langsmith/manage-trace#view-server-logs) associated with a trace execution.
...
> [!NOTE]
> Viewing server logs for a trace only works with the [Cloud SaaS](https://docs.langchain.com/langsmith/cloud) and [fully self-hosted](https://docs.langchain.com/langsmith/self-hosted) deployment options.
...
> **Image:** [Deployment server logs filters](https://docs.langchain.com/langsmith/manage-trace)
...
For full API usage, including code examples, the 1000-trace-per-request limit, deletion timeline, and metadata matching behavior, refer to [Data purging for compliance](https://docs.langchain.com/langsmith/data-purging-compliance#trace-deletes).
