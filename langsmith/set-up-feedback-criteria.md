...
>
> * [Conceptual guide on tracing and feedback](https://docs.langchain.com/langsmith/observability-concepts)
...
> [!NOTE]
> You can also manage feedback configs programmatically with the SDK. Refer to [Manage feedback & annotation queues programmatically](https://docs.langchain.com/langsmith/annotation-queues-sdk).

> [!TIP]
> For free-form acceptance criteria a reviewer writes per-run (rather than a fixed set of rubric scores), refer to [Use assertions](https://docs.langchain.com/langsmith/assertions).
...
> **Image:** [Cont feedback](https://docs.langchain.com/langsmith/set-up-feedback-criteria)
...
> **Image:** [Cat feedback](https://docs.langchain.com/langsmith/set-up-feedback-criteria)
