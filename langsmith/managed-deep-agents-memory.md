...
Memory is not your system prompt. Define always-on behavior in [instructions](python/managed-deep-agents-instructions.md) and task-specific procedures in [skills](python/managed-deep-agents-skills.md); use memory for durable knowledge the agent learns while it runs.
