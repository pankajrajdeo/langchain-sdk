...
> [!TIP]
> To define code evaluators in the LangSmith UI, refer to [How to define a code evaluator (UI)](https://docs.langchain.com/langsmith/code-evaluator-ui). To grade outputs against assertions saved on dataset examples, refer to [Use assertions](https://docs.langchain.com/langsmith/assertions).
...
* `run: Run`: The full [Run](https://docs.langchain.com/langsmith/run-data-format) object generated by the application on the given example.
...
* [Evaluate aggregate experiment results](https://docs.langchain.com/langsmith/summary): Define summary evaluators, which compute metrics for an entire experiment.
* [Run an evaluation comparing two experiments](https://docs.langchain.com/langsmith/evaluate-pairwise): Define pairwise evaluators, which compute metrics by comparing two (or more) experiments against each other.
