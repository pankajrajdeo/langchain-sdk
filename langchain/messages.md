# Messages
> Source: [Original LangChain documentation](https://docs.langchain.com/oss/python/langchain/messages)
...
For models that support [tool calling](https://docs.langchain.com/oss/python/langchain/models#tool-calling), AI messages can contain tool calls. Tool messages are used to pass the results of a single tool execution back to the model.

[Tools](https://docs.langchain.com/oss/python/langchain/tools) can generate [`ToolMessage`](https://reference.langchain.com/python/langchain-core/messages/tool/ToolMessage) objects directly. Below, we show a simple example. Read more in the [tools guide](https://docs.langchain.com/oss/python/langchain/tools).
...
> ```
>
> See the [RAG tutorial](https://docs.langchain.com/oss/python/deepagents/rag) for an end-to-end example of building retrieval [agents](https://docs.langchain.com/oss/python/langchain/agents) with LangChain.
>
> </details>
...
You can think of a message's content as the payload of data that gets sent to the model. Messages have a `content` attribute that is loosely-typed, supporting strings and lists of untyped objects (e.g., dictionaries). This allows support for provider-native structures directly in LangChain chat models, such as [multimodal](https://docs.langchain.com/oss/python/langchain/messages#multimodal) content and other data.

Separately, LangChain provides dedicated content types for text, reasoning, citations, multi-modal data, server-side tool calls, and other message content. See [content blocks](https://docs.langchain.com/oss/python/langchain/messages#standard-content-blocks) below.
...
[Chat models](https://docs.langchain.com/oss/python/langchain/models) can accept multimodal data as input and generate
