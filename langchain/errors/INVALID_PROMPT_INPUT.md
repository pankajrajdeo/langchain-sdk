...
3. Debug by examining actual inputs to your prompt template by using [LangSmith](https://docs.langchain.com/langsmith/observability) or logging to verify they match expectations
